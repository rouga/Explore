...
public:
	...
	virtual void Setup(VkCommandBuffer iCmd, FrameResources* iFrameResources) = 0;
	virtual void Begin(VkCommandBuffer iCmd, FrameResources* iFrameResources) = 0;
	virtual void Draw(VkCommandBuffer iCmd, FrameResources* iFrameResources) = 0;
	virtual void End(VkCommandBuffer iCmd, FrameResources* iFrameResources) = 0;
protected:
